...
import { CardElement, useStripe as Stripe, useElements as Elements } from '@stripe/react-stripe-js';
    ...
    Effect(() => {
        ...
        const getClientSecret = async () => {
            const response = await axios({
                ...
                url: `/checkout/create?total=${totalPrice * 100}`
            });
        ...
        <>
            ...
            <div className="checkOutContainer">
                ...
                <div className="middleproduct">
                    <h2 className="h2">Reviews items and <br /> delivery</h2>
                        ...
                        <div className="card">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="bottom">
                                    ...
                                    <button type="submit" className="buy" disabled={processing || disabled || succeeded}>
